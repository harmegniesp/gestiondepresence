...
class SchoolDao extends \dao\Dao
{
    ...
    public function find(int $id):\entities\School
    {
        if ($id==0)
    ...
    public function findAll():\entitiesTools\ArrayCollection
    {
    ...
    public function findAllQuick():\entitiesTools\ArrayCollection
    {
        $sql="SELECT * FROM school;";
        $st=$this->pdo->query($sql);
    ...
    public function findWithLimit(int $position, int $group):\entitiesTools\ArrayCollection
    {
    ...
    public function mergeCourses(\entities\School $object)
    {
            ...
            //var_dump($result);
                if( empty($result) )
                    ...
                    foreach ($result as $value) {
                        ...
                        $value['startDate'] = \entitiesTools\Conversion::convertDate_DateTime($value['startDate']);
                        $value['endDate'] = \entitiesTools\Conversion::convertDate_DateTime($value['endDate']);
